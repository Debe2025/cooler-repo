...
| Internet Archive Movies | Public domain and classic films | No subscription |
### Dependency Modules
- **SlyGuy Shared Module**: Required for DStv Now, Samsung TV Plus
- **InputStream Helper**: Supports DRM streaming for Kodi
---
...
https://debe2025.github.io/cooler-repo/
4. Name it **Cooler Repo** and click **OK**.
5. Return to the main menu → **Add-ons → Install from zip file**.
6. Choose **Cooler Repo** → install `repository.myrepo-1.0.0.zip`.
7. Then go to **Install from repository → My Cooler Repo** to browse and install addons.
---
## 🔗 Direct Repository URL
- GitHub Pages link: [https://debe2025.github.io/cooler-repo/](https://debe2025.github.io/cooler-repo/)
- Direct zip download: [https://debe2025.github.io/cooler-repo/repository.myrepo-1.0.0.zip](https://debe2025.github.io/cooler-repo/repository.myrepo-1.0.0.zip)
---
## ⚠️ Notes
- Some addons (like DStv Now and Netflix) require a **paid subscription** and login credentials.
- Free addons (Pluto TV, Tubi, Crackle, Internet Archive) are **ad-supported** but do not require login.
...
[https://github.com/Debe2025/cooler-repo](https://github.com/Debe2025/cooler-repo) 
